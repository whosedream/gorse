import { Ft as onMounted, Kn as ref, _n as watchEffect, jt as onBeforeUnmount } from "./vue.runtime.esm-bundler-dM5W6Okq.js";
...
var vAutoAnimate = {
	mounted: (el, binding) => {
		...
		Object.defineProperty(el, "__aa_ctl", {
			value: ctl,
			configurable: true
		});
	},
	unmounted: (el) => {
		...
		(_a = ctl === null || ctl === void 0 ? void 0 : ctl.destroy) === null || _a === void 0 || _a.call(ctl);
		try {
			delete el["__aa_ctl"];
		} catch {}
	},
...
function createVAutoAnimate(defaults) {
	return {
		mounted(el, binding) {
			...
			if (typeof local === "function") resolved = local;
			else if (typeof defaults === "function") resolved = defaults;
			else resolved = {
				...defaults || {},
				...local || {}
			};
...
var autoAnimatePlugin = { install(app, defaults) {
